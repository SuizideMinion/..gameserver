        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="/{{ \Request::segment(1) }}/translation">
                        @if( isset($id) )
                        ...
                        <table class="table datatable">
                            ...
                            @foreach($Translations as $Translation)
                                <tr onclick="window.location.href = '/{{ \Request::segment(1) }}/translation/{{ $Translation->id }}/edit';" style="cursor: pointer;">
